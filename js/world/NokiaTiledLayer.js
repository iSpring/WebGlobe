define(["world/TiledLayer"], function(TiledLayer) {
  ...
  NokiaTiledLayer.prototype.getImageUrl = function(level, row, column) {
    ...
    var url = "http://"+idx+".base.maps.api.here.com/maptile/2.1/maptile/2ae1d8fbb0/normal.day/"+level+"/"+column+"/"+row+"/512/png8?app_id=xWVIueSv6JL0aJ5xqTxb&app_code=djPZyynKsbTjIUDOBcHZ2g&lg=eng&ppi=72&pview=DEF";
    return url;
  };
